pipeline {
    ...
    environment {
        NETLIFY_SITE_ID = 'b67f0cec-a3f8-44b5-b7d3-d54af82b9a70'
    ...
    stages {
        ...
        stage('Prod E2E') {
            ...
            post {
                always {
                    publishHTML([allowMissing: false, alwaysLinkToLastBuild: false, keepAll: false, reportDir: 'playwright-report', reportFiles: 'index.html', reportName: 'Playwright E2E', reportTitles: '', useWrapperFileDirectly: true, includes: '**/*'])
                }
            }
        }
    }
